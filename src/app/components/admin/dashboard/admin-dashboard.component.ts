    ...
    <div>
      ...
      <div class="mb-8">
        ...
        <p class="mt-1 text-sm text-gray-600">
          Hello, {{ currentUser.username }}! Manage your photography portfolio.
        </p>
        }
      </div>
      ...
      <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <button
              class="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
            >
              <svg
